...
<section class="featured"> 
        <div class="container featured__container">
            <div class="post__thumbnail">
                <img src="./image/<?= $featured['thumbnail'] ?>" alt="">
            </div>
            <div class="post__info">
                ...
                <h2 class="post__title"><a href="<?= ROOT_URL ?>posts.php?id=<?= $featured['id'] ?>"><?= $featured['title'] ?></a></h2>
                <p class="post__body">
                    <?= substr($featured['body'], 0, 300) ?>... <!-- you only want 300 characters show up -->
                </p>
